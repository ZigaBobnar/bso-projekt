...
float mouse_move_queue[2][32];
uint8_t mouse_move_queue_index = 0;
...
void IMU::update() {
    ...
    //     MadgwickQuaternionUpdate(-accelerometer.x, +accelerometer.y, +accelerometer.z, gyroscope.x*pi/180.0f, gyroscope.y*pi/180.0f, gyroscope.z*pi/180.0f, magnetometer.values.x, -magnetometer.values.y, magnetometer.values.z);
    // }
    ...
    // roll  *= 180.0f / pi;
    // lin_ax = accelerometer.x + a31;
    // lin_ay = accelerometer.y + a32;
    // lin_az = accelerometer.z - a33;
...
// Obtained from https://github.com/kriswiner/MPU9250/blob/master/AK8963_as_slave/MadgwickFilter
