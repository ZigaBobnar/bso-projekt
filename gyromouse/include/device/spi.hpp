...
/*
 * Customization of SPI protocol driver to allow for mutex-based access to the bus and devices.
 * 
...
class SPIBus {
public:
    // SPIBus(uint8_t bus_id, uint8_t scl_pin_number, uint8_t sda_pin_number);
